                    ...
                    <div class="card shadow border-0" style="width: 95%;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4">
                                <a href="productmanagement?service=requestInsert" class="btn btn-warning">
                                    <i class="bi bi-plus-circle me-1"></i> Insert New Product
                                </a>
                            </div>

                            <!-- Search Form -->
                            <form action="productmanagement" class="input-group search-form shadow-sm" method="get" onsubmit="return validateSearch()">
            ...
            <tbody>
                <c:forEach var="product" items="${allProducts}">
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="productmanagement?service=requestUpdate&productId=${product.id}" class="btn btn-success btn-edit">
