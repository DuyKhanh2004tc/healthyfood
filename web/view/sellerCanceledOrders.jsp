...
<head>
    ...
    <link rel="stylesheet" href="CSS/processingOrders.css"> <!-- Đồng bộ style -->
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="page-title text-center fw-bold mb-4">Canceled Orders</h1>
        ...
        <div class="row">
            <c:choose>
                    ...
                    <c:forEach var="order" items="${canceledOrders}">
                        <div class="col-md-6 mb-4">
                            <div class="order-card shadow-sm">
                                <div class="card-body">
                                    <p><strong>Order ID:</strong> <a href="${pageContext.request.contextPath}/SellerCanceledOrdersServlet?orderId=${order.id}" class="order-link">${order.id}</a></p>
                ...
                <c:otherwise>
                    <p class="text-center text-muted">No canceled orders.</p>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
