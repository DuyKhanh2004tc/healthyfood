        ...
        <script>
            document.querySelector(".form-placeOrder").addEventListener("submit", function (e) {
                ...
                if (district === "") {
                    ...
                    valid = false;
                } else if (!/^[^$%!@#^*=\[\]{};:"\\|<>?~`]+$/.test(district)) {
                    document.getElementById("errorDistrict").innerText = "District contains invalid special characters.";
                    valid = false;
                }
                ...
                if (province === "") {
                    ...
                    valid = false;
                } else if (!/^[^$%!@#^*=\[\]{};:"\\|<>?~`]+$/.test(province)) {
                    document.getElementById("errorProvince").innerText = "Province/City contains invalid special characters.";
                    valid = false;
                }
