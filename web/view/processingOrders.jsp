...
<body>
    ...
    <div class="container mt-4">
        <h1 class="page-title text-center fw-bold mb-4">Processing Orders</h1>
                    ...
                    <c:forEach var="order" items="${processingOrders}">
                        <div class="col-md-6 mb-4">
                            <div class="order-card shadow-sm">
                                <div class="card-body">
                                    <p><strong>Order ID:</strong> <a href="${pageContext.request.contextPath}/ProcessingOrders?orderId=${order.id}" class="order-link">${order.id}</a></p>
